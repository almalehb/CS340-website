...
function editRow(row) {
    ...
    if (editButton.textContent === 'Edit') {
        ...
        const editedData = {
            ...
            totalCost: cells[4].querySelector('input').value ? parseFloat(cells[4].querySelector('input').value) : null
        };
        ...
        cells[4].textContent = editedData.totalCost === null ? '' : editedData.totalCost.toFixed(2);
