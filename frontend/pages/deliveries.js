...
function renderDeliveriesTable(deliveries){
    ...
    deliveries.forEach((delivery) => {
        ...
        deleteButton.addEventListener('click', () => deleteDelivery(delivery.deliveryId));
...
fetchOptions('/api/restaurants', document.getElementById('restaurantId'), 'restaurantId', 'restaurantId');
...
function addDelivery() {
    ...
    const data = `ingredientId=${encodeURIComponent(
      ...
      )}&supplierId=${encodeURIComponent(supplierInput.value)}&restaurantId=${encodeURIComponent(restaurantInput.value)}&deliveryDate=${encodeURIComponent(dateInput.value)}`;
...
function editDelivery(editedData) {
    ...
    const data = `ingredientId=${encodeURIComponent(
      ...
      )}&supplierId=${encodeURIComponent(editedData.supplierId)}&restaurantId=${encodeURIComponent(editedData.restaurantId)}&deliveryDate=${encodeURIComponent(editedData.deliveryDate)}`;
